...
namespace terasu_controller_GUI.ViewModels
{
    public sealed class SettingsViewModel : ViewModelBase
    {
        ...
        {
            get => _c.Security.BasicAuth.Enabled;
            set
            {
                _c.Security.BasicAuth.Enabled = value;
                this.RaisePropertyChanged();
            }
        }
        public string BasicUser
        {
            get => _c.Security.BasicAuth.Username;
            set
            {
                _c.Security.BasicAuth.Username = value;
                this.RaisePropertyChanged();
            }
        }
        public string BasicPass
        {
            get => _c.Security.BasicAuth.Password;
            set
            {
                _c.Security.BasicAuth.Password = value;
                this.RaisePropertyChanged();
            }
        }
